                    ...
                    if (password == confirmPassword) {
                        ...
                        if (userId > 0) {
                           ...
                           // navController.navigate(AppScreen.MainScreen.route)
                            //navController.navigate("${AppScreen.MainScreen.route}/$name")
//                            name = usuario.nome
                            //navController.navigate(AppScreen.MainScreen.route)
//                            navController.navigate(
//                                route = "${AppScreen.MainScreen.route}/$name"
//                            )
                            // Supondo que "name" seja uma variável que contém o nome do usuário
                           // navController.navigate("${AppScreen.MainScreen.route}/$name")


                            navController.navigate(AppScreen.MainScreen.route + "?name=$name")
